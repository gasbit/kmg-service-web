  ...
  return (
    <>
      <header
        ...
        className="fixed inset-x-0 top-0 z-30 flex min-h-24 items-center justify-between gap-4 border-b border-slate-200/80 bg-white/95 px-4 pl-16 shadow-sm backdrop-blur-xl sm:px-6 sm:pl-20 lg:left-[248px] lg:px-8"
      >
